module.exports = [
  ...
  ["play drum %d.drum for %n beats", " ", 13, "playDrum"],
  ["rest for %n beats", " ", 13, "rest:elapsed:from:"],
  ["play note %d.note for %n beats", " ", 13, "noteOn:duration:elapsed:from:"],
  ["set instrument to %d.instrument", " ", 13, "instrument:"],
  ["change volume by %n", " ", 3, "changeVolumeBy:"],
  ["set volume to %n%", " ", 3, "setVolumeTo:"],
  ["change tempo by %n", " ", 13, "changeTempoBy:"],
  ["set tempo to %n bpm", " ", 13, "setTempoTo:"],
  ...
  ["turn video %m.videoState", " ", 14, "setVideoState"],
  ["set video transparency to %n%", " ", 14, "setVideoTransparency"],
